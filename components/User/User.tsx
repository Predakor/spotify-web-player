...
function User({ user }: { user: SpotifyUser }) {
  ...
  return (
    <article className="dropdown-end dropdown-bottom dropdown ml-auto hidden cursor-default items-center gap-2 rounded-full bg-neutral p-1 pr-3 text-lg md:flex">
